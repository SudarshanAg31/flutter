  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: isDarkMode ? const Color.fromARGB(255, 190, 190, 190) : const Color.fromARGB(255, 142, 229, 239),
        foregroundColor: const Color.fromARGB(255, 74, 73, 73),
        elevation: 0,
      ),
      body: Container(
        color: isDarkMode ? const Color.fromARGB(255, 176, 175, 175) : const Color.fromARGB(255, 154, 224, 241),
